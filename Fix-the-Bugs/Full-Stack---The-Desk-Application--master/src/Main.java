...
public class Main {
	...
	private static void optionsSelection() {
		...
		String[] optionsArray = { "1. I wish to review my expenditure", "2. I wish to add my expenditure",
		...
		for (String optionSelection : optionsArray) {
	...
	private static void searchExpenses(ArrayList<Integer> arrayList, Integer value) {
		...
		if (foundResult) {
			System.out.println("Expense found: " + value + "\n");
		} else {
